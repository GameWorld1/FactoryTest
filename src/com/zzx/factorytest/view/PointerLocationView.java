...
public class PointerLocationView extends View {
    ...
    public PointerLocationView(Context c) {
        ...
        canvas.drawRect(0 , 0, 80, 80, mTextBackgroundPaint); 
        */
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (false) {
            Log.i("foo", "Metrics: ascent=" + mTextMetrics.ascent+ " descent=" + mTextMetrics.descent
                    + " leading=" + mTextMetrics.leading + " top=" + mTextMetrics.top
    ...
    protected void onDraw(Canvas canvas) {
        synchronized (mPointers) {
          ...
          /*  mWhitePaint.setColor(Color.WHITE);
            canvas.drawRect(0, 15, 80, 80, mWhitePaint);*/
            ...
            for (int p=0; p<NP; p++) {
                ...
                if (mCurDown && ps.mCurDown) {
                    ...
                    canvas.drawCircle(ps.mCurX, ps.mCurY, (ps.mCurWidth * 0.5f), mPaint);
                   // onTouchThis(ps.mCurX,ps.mCurY,canvas,mWhitePaint);
                }
            }
    ...
    private void onTouchThis(int mCurX, int mCurY, Canvas canvas, Paint mPaint) {
        // TODO Auto-generated method stub
        
        if(mPointers.get(0).mCurX<80&&mPointers.get(0).mCurY<80){
            mPaint.setColor(Color.GREEN);
            canvas.drawRect(0, 15,getWidth(), 80, mPaint);
            if(mCurX<getWidth()&&mCurY<80){
                Paint myPaint = new Paint();
                myPaint.setColor(Color.GREEN);
                canvas.drawRect(0, 15,getWidth(), 80, myPaint);
            }
        }
        else{
            mPaint.setColor(Color.RED);
            canvas.drawRect(0, 80,getWidth(), getHeight(), mPaint);
            canvas.drawRect(80, 15, getWidth(), 80, mPaint);
